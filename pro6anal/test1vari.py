...
print("1반(성적 편차 작음)")
print(f"평균:{mean1}, 평균:{std1}, 평균:{var1}")
print("2반(성적 편차 큼)")
print(f"평균:{mean2}, 평균:{std2}, 평균:{var2}")
...
# 국어 선생님 입장
# 두 반의 국어 점수의 표준편차(평균)는 차이가 없다
# 누군가가 실험을 통해 데이터 수집 후 두반의 점수에 통계 계산 후 새로운 주장(의견)
# 대립 가설 : 두 반의 국어 점수의 표준편차(평균)는 차이가 있다.
# 가설검정(t-test)을 통해 두 의견의 채택, 가격을 판단할 수 있다.
