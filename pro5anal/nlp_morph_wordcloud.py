# 동아일보 에서 특정 단어 관련 문서들 검색 후 명사만 추출하여 wordcloud 연습

from bs4 import BeautifulSoup
from urllib.parse import quote
import urllib.request
from konlpy.tag import Okt
from collections import Counter     # 단어 수를 세는 라이브러리
import pytagcloud
...
for title in soup.find_all("h4", class_="tit"):
    ...
    pytagcloud.create_tag_image(tag_list,'word.png', size=(1000,600), background=(0,0,0), fontname='korean', rectangular=False)
